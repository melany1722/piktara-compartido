...
const equipo = [
  ...
  },
  {
    ...
    img: null,
    desc: "tengo 18 años y entre mis pasiones es el arte asptracto, todo lo relacionado con el el dibujo y el arte, soy una chica solidaria y alegre..",
  },
  {
    nombre: "JUAN LOPERA",
    img: null,
    desc: "tengo 18 años y me gusta mucho la tecnología y los videojuegos, soy un chico muy creativo y me gusta mucho el diseño gráfico.",
  },
];
        ...
        <div className="collapse navbar-collapse justify-content-center" id="menu">
          <ul className="navbar-nav gap-5">
            <li className="nav-item">
              <a className="nav-link" href="#" style={{ fontFamily: f, fontSize: "0.75rem", letterSpacing: "0.15em", color: "#2a2a2a", textTransform: "uppercase", borderBottom: "2px solid #2a2a2a", paddingBottom: "2px" }}>Sobre Piktara</a>
            </li>
            <li className="nav-item">
             <Link to="/" className="nav-link" style={{ fontFamily: f, fontSize: "0.75rem", letterSpacing: "0.15em", color: "#2a2a2a", textTransform: "uppercase" }}>Nuestro Cómic</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="position-relative overflow-hidden" style={{ minHeight: "400px" }}>
        ...
        <div className="position-relative d-flex flex-column align-items-center justify-content-center text-center py-5 px-4" style={{ zIndex: 2, minHeight: "400px" }}>
          ...
          <p className="fst-italic" style={{ fontFamily: f, fontSize: "0.88rem", lineHeight: 1.85, color: "#fff", maxWidth: "600px", textShadow: "0 1px 8px rgba(0,0,0,0.6)" }}>
            Piktara es una marca fuerte, elegante y sofesticada,es una marca creativa que une arte, historia y narrativa digital. Su esencia nace de la inspiración en lo antiguo y lo místico, transformado en experiencias modernas como cómics y proyectos visuales. Representa innovación, imaginación y conexión con símbolos que trascienden el tiempo..
          </p>
        </div>
      </div>

      {/* BANNER PIKTARA */}
      <div id="piktara" className="text-center py-4" style={{ background: "#e8d5b0" }}>
          ...
          <div className="row align-items-start g-5">
            ...
            <div className="col-md-8">
              <p style={{ fontFamily: f, fontSize: "0.85rem", lineHeight: 1.9, color: "#3a3a3a" }}>
                PIKTARA surge Del Egipto antiguo,
Se conecta con los jeroglíficos y los pictogramas (de ahí “PIK”), ya que la escritura egipcia era una forma de arte visual y sagrada. “TARA” puede relacionarse con el concepto de estrella, muy importante en Egipto porque los astros (como Sirio) guiaban las cosechas, los calendarios y hasta la construcción de las pirámides..
              </p>
            </div>
          </div>
        </div>
     ...
     {/* SECCIÓN EQUIPO */}
      <section id="equipo" className="py-5" style={{ background: "#c8a870" }}>
              ...
              <div key={i} className="col-12 col-md-4 text-center">
                <div className="mx-auto mb-3" style={{ width: "160px", height: "200px", background: "#f0ebe0", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
                  {miembro.img
                    ...
                    : <i className="bi bi-person-fill" style={{ fontSize: "5rem", color: "#2a2a2a", opacity: 0.3 }}></i>
                  }
                </div>
