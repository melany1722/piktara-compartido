...
export default function Trailer() {
  ...
  return (
    <div style={{ background: palette.crema, minHeight: "100vh", fontFamily: fBody, color: palette.borde }}>
      ...
      {/* ── NAVBAR ── */}
      <nav
        className="navbar navbar-expand-lg px-4 px-md-5 justify-content-between"
        style={{
          background: palette.amarillo,
      ...
      <section className="py-5 px-3" style={{ background: palette.crema }}>
        <div className="container" style={{ maxWidth: "1100px" }}>
          <div className="row align-items-center g-4 p-4 p-md-5 comic-box mx-auto" style={{ position: "relative" }}>
